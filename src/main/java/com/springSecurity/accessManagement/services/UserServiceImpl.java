...
import com.springSecurity.accessManagement.repositories.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    private BCryptPasswordEncoder passwordEncoder; // Fails when injected by the constructor
